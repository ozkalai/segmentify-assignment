...
document.querySelector(".swiper-wrapper").innerHTML = products
  .map(
    (product) =>
      ...
      <div class="card-wrapper">
          ...
          <span>${
            product.oldPrice
              ? `-${(
                  ((product.oldPrice - product.price).toFixed(1) * 100) /
          ...
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              ...
              <path
                  ...
                  fill="#861c63" /></svg>
          <span>${product.params.likeCount}</span>
      </div>`
              : ""
          }
      </div>`
          ...
          <div class="product-details">
              ...
              <div class="product-params">
                  <span>${product.params.land}</span><span>${
        ...
        product.params.art ? `| ${product.params.art} ` : ""
              ...
              <div class="older-price">${product.oldPriceText}</div>
          </div>`
                  : `<div class="product-price">
          <div class="price">${product.priceText}</div>
      </div>`
